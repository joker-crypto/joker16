                ...
                <nav class="navbar-color">
                    <div class="nav-wrapper">
                        ...
                        <ul class="right hide-on-med-and-down">
                            <li><a href="#" class="waves-effect waves-block waves-light"><i class="money">
                                        <!-- Balance: &#8369--> <?php // echo $balance; 
                                                                ?></i></a>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="wrapper">
                ...
                <aside id="left-sidebar-nav">
                    <ul id="slide-out" class="side-nav fixed leftside-navigation">
                        ...
                        <li class="bold"><a href="hello" class="waves-effect waves-cyan"><i class="mdi-action-shopping-cart"></i> Order Products</a>
                        </li>
                        <li class="no-padding">
                            <ul class="collapsible collapsible-accordion">
                                <li class="bold"><a class="collapsible-header waves-effect waves-cyan active"><i class="mdi-content-content-paste"></i> Orders</a>
                                ...
                                <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-action-question-answer"></i> Feedback</a>
                                    <div class="collapsible-body">
                                        <ul>
                                            ...
                                            while ($row = mysqli_fetch_array($sql)) {
                                                echo '<li><a href="tFeedback?status=' . $row['status'] . '">' . $row['status'] . '</a>
                                    </li>';
                                            }
                                            ?>
                                        </ul>
                ...
                <div>
                    ...
                    <ul id="issues-collection" class="collection">';
                            while ($row = mysqli_fetch_array($sql)) {
                              ...
                              <p><strong>Status:</strong> ' . ($status == 'Paused' ? 'Paused <a href="Feedback" data-position="bottom" data-delay="50" data-tooltip="Please contact administrator for further details." class="btn-floating waves-effect waves-light tooltipped cyan">    ?</a>' : $status) . '</p>							  
							  ' . (!empty($row['description']) ? '<p><strong>Location To be Delivered:  </strong>' . $row['description'] . '</p>' : '') . '						                               
                            ...
                            <span>&#8369 ' . $row1['price'] . '</span>
                                ...
                                echo '<li class="collection-item">
                                        <div class="row">
                                            ...
                                            <div class="col s3">
                                                <span><strong> &#8369 ' . $row['total'] . '</strong></span>
                                            </div>';
