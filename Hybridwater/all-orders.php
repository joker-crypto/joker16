            ...
            <div class="wrapper">
                ...
                <aside id="left-sidebar-nav">
                    <ul id="slide-out" class="side-nav fixed leftside-navigation">
                        ...
                        <li class="bold"><a href="us" class="waves-effect waves-cyan"><i class="mdi-social-person"></i> Users</a>
                    ...
                    <ul id="issues-collection" class="collection">';
                            while ($row = mysqli_fetch_array($sql)) {
							  ...
							  <form method="post" action="routers/edit-orders.php">
                                ...
                                <option type="hidden" value="Cancelled by Admin" ' . ($status == 'Cancelled by Admin' ? 'selected' : '') . '>Cancelled by Admin</option> 
                            ...
                            <span> &#8369 ' . $row1['price'] . '</span>
                                ...
                                if (!$deleted) {
                                    echo '<button id="change" class="btn waves-effect waves-light right submit" type="submit" name="action">Change Status
