      ...
      <div class="navbar-fixed">
        <nav class="navbar-color">
          <div class="nav-wrapper">
            <ul class="left">
              <li>
                <h1 class="logo-wrapper"> Hybrid Waters<a href="hello" class="brand-logo darken-1"><img style="width: 40px; margin:0% " src="images/icon1.png" alt="logo"></a> <span class="logo-text">Logo</span><br></h1>
              </li>
            </ul>
      ...
      <div class="wrapper">
        ...
        <aside id="left-sidebar-nav">
          <ul id="slide-out" class="side-nav fixed leftside-navigation">
            <li class="user-details cyan darken-2">
              <div class="row">
                <div class="col col s4 m4 l4">
                  <img src="images/customer.png" alt="" class="circle responsive-img valign profile-image">
                </div>
            ...
            <li class="bold"><a href="hello" class="waves-effect waves-cyan"><i class="mdi-action-shopping-cart"></i> Order Food</a>
            </li>
            <li class="no-padding">
            ...
            <li class="bold"><a href="details" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Edit Details</a>
            </li>
          </ul>
                    ...
                    <form class="formValidate col s12 m12 l6" id="formValidate" method="post" action="confirm-order.php" novalidate="novalidate">
                      ...
                      <div class="row">
                        <div class="input-field col s12">
                          ...
                          <label for="cvv_number" class="">Wallet ID</label>
  ...
  here --
                      <div class="row">
                        <div class="input-field col s12">
                          ...
                          <label for="cc_number" class="">Wallet Number</label>
        ...
        <div class="row">
            ...
            <div class="col s3">
                <span><strong>&#8369 ' . $total . '</strong></span>
            </div>
        </div>
    </li>';
                    if (!empty($_POST['description']))
                      echo '<li class="collection-item avatar"><p><strong>Delivery Location: </strong>' . htmlspecialchars($_POST['description']) . '</p></li>';
                    ?>
                  </ul>
