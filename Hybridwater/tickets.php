    ...
    <div id="main">
      ...
      <div class="wrapper">
                  ...
                  <div class="collapsible-body">
                    <ul>
                      ...
                      while ($row = mysqli_fetch_array($sql)) {
                        ...
                        echo '<li class=' . (isset($_GET['status']) ? ($status == $_GET['status'] ? 'active' : '') : '') . '><a href="Feedback?status=' . $row['status'] . '">' . $row['status'] . '</a>
                                    </li>';
                      }
                      ?>
                    </ul>
        ...
        <section id="content">
          ...
          <!--start container-->
          <div class="container">
            <p class="caption">Feedback List</p>
            <div class="divider"></div>
