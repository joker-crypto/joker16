        ...
        <nav class="navbar-color">
          <div class="nav-wrapper">
            ...
            <ul class="right hide-on-med-and-down">
              <!--      <li><a href="#" class="waves-effect waves-block waves-light"><i class="money">Balance: &#8369 <?php echo $balance; ?></i></a>-->
              </li>
            </ul>
          </div>
        </nav>
    ...
    <div id="main">
      ...
      <div class="wrapper">
        ...
        <section id="content">
          ...
          <div class="container">
            <p class="caption">Order your Product here.</p>
            <div class="divider"></div>
            <form class="formValidate" id="formValidate" method="post" action="place-order.php" novalidate="novalidate">
              <div class="row">
                <div class="col s12 m4 l3">
                  <h5 class="header">Products <li style="color: red"> (Maximum of 10 per items)</li>
                  </h5>
                </div>
                <div>
                  <table id="data-table-customer" class="d-block w-100 display" cellspacing="0" style="background-color:#454D66 ">
                    <thead>
                      <tr>
                    ...
                    <tbody>
                      ...
                      while ($row = mysqli_fetch_array($result)) {
                        echo '<tr><td width: 20%><img style=" width: 80px; height: 80px" src="' . $row["image"] . '"</td>';
                        echo '<td>' . $row["name"] . '</td><td> &#8369 ' . $row["price"] . '</td>';
                ...
                <div class="input-field col s12">
                  ...
                  <label for="description" style="color: black;" class="">Note(Pls. Enter your current location)</label>
                </div>
                <div>
                  <div class="input-field col s12">
